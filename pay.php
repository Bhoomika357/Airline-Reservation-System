      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown" id = "new">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" ><span class="glyphicon glyphicon-user">MY TRIPS</span>
...
<div class="jumbotron text-center">
        <h1>Book Your Airline</h1> 
        <p>Welcome to your online flight booking platform!</p> 
</div>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <div><img src="imag.jpg" alt="imag" id="imag">
      </div>
<?php
